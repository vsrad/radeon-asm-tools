...
namespace VSRAD.Syntax.IntelliSense.SignatureHelp
{
    internal sealed class SignatureConfig
    {
        ...
        public SignatureConfig(char triggerSigChar, char triggerParamChar, char dismissSigChar,
            string sigStart, string sigEnd)
        {
            TriggerSignatureChar = triggerSigChar;
        ...
        public char TriggerSignatureChar { get; }
