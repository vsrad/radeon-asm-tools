...
namespace VSRAD.Syntax.Core.Lexer
{
    public class Asm1Lexer : ILexer
    {
        ...
        private static readonly Dictionary<int, RadAsmTokenType> _tt = new Dictionary<int, RadAsmTokenType>()
        {
            ...
            { RadAsmLexer.LOGAND, RadAsmTokenType.Operation },
            { RadAsmLexer.LOGOR, RadAsmTokenType.Operation },
            ...
            { RadAsmLexer.PROD, RadAsmTokenType.Operation },
            { RadAsmLexer.DIV, RadAsmTokenType.Operation },
            { RadAsmLexer.MOD, RadAsmTokenType.Operation },
            { RadAsmLexer.BITXOR, RadAsmTokenType.Operation },
            { RadAsmLexer.BITAND, RadAsmTokenType.Operation },
            { RadAsmLexer.BITOR, RadAsmTokenType.Operation },

            { RadAsmLexer.COMMA, RadAsmTokenType.Comma },
            { RadAsmLexer.SEMI, RadAsmTokenType.Semi },
            { RadAsmLexer.COLON, RadAsmTokenType.Colon },
            { RadAsmLexer.LPAREN, RadAsmTokenType.Lparen },
            { RadAsmLexer.RPAREN, RadAsmTokenType.Rparen },
            { RadAsmLexer.LSQUAREBRACKET, RadAsmTokenType.LsquareBracket },
            { RadAsmLexer.RSQUAREBRACKET, RadAsmTokenType.RsquareBracket },
            { RadAsmLexer.LCURVEBRACKET, RadAsmTokenType.LcurveBracket },
            { RadAsmLexer.RCURVEBRACKET, RadAsmTokenType.RcurveBracket },
